...
MOCK_CAPTIONS = {
    ...
    "ethereal": [
        {"text": "Catching light and feelings in the heart of the digital neon. ⚡", "mood": "VIBRANT"},
        {"text": "Just another glitch in the beautiful simulation we call home. 🚀", "mood": "DEEP"},
        ...
        for model_info in models:
            ...
            try:
                ...
                system_prompt = (
                    ...
                    f'Return ONLY valid JSON in this exact format: {{"captions": [{{"text": "...", "mood": "VIBRANT|DEEP|ETHEREAL"}}]}}'
                )
                ...
                if req.image:
                    content.append({"type": "image_url", "image_url": {"url": f"data:image/jpeg;base64,{req.image}"}})
                elif req.imageUrl:
                    content.append({"type": "image_url", "image_url": {"url": req.imageUrl}})
                ...
                return CaptionResponse(
                    captions=[CaptionDraft(**c) for c in result["captions"][: req.count]]
                )
